...
const api = {
  ...
  getVideoTitle: (url: string) => ipcRenderer.invoke('get-video-title', url),
  ...
  enhanceImage: (fileBufferArray: number[], fileName: string, options: any, processId: string) =>
    ipcRenderer.invoke('enhance-image', fileBufferArray, fileName, options, processId)
}
