...
function EnhanceImage() {
  ...
  const handleEnhanceProgress = useCallback(
    (data: { id: string; percent: number }) => {
  ...
  useEffect(() => {
    ...
    return () => {
      // No cleanup needed when window.api is not available
    }
  ...
  return (
    <div
      className={`min-h-screen p-4 flex justify-center sm:p-6 ${isDarkMode ? 'bg-gray-900' : 'bg-gradient-to-br from-purple-50 to-white'}`}
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className=" text-center mb-6 sm:mb-8">
          ...
          <p
            className={` text-base sm:text-lg px-4 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'} max-w-3xl mx-auto`}
          >
        ...
        <div className="space-y-6 lg:space-y-8">
          {/* Upload Section */}
          <div
            className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-xl border ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}
          >
            <h2
              className={`text-lg sm:text-xl font-semibold mb-4 flex items-center gap-2 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}
            >
            ...
            >
              {preview ? (
                ...
                <>
                  <FileImage
                    className={`w-8 h-8 sm:w-12 sm:h-12 mx-auto mb-2 sm:mb-4 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}
                  />
                  <p
                    className={`text-sm sm:text-lg font-medium mb-1 sm:mb-2 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}
                  >
            ...
            {selectedFile && (
              <div
                className={`mt-4 p-3 rounded-lg ${isDarkMode ? 'bg-gray-700' : 'bg-gray-100'} overflow-hidden`}
              >
                <div
                  className={`text-xs sm:text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'} space-y-1`}
                >
            ...
            <div className="mt-6 space-y-4">
              <h3
                className={`text-base sm:text-lg font-semibold flex items-center gap-2 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}
              >
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
              <div className="space-y-3">
                <h3
                  className={`text-base sm:text-lg font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}
                >
                  Original
                </h3>
                <div
                  className={`rounded-xl sm:rounded-2xl border-2 border-dashed ${!preview ? 'aspect-square sm:aspect-[4/3]' : 'min-h-[250px] sm:min-h-[350px]'} flex items-center justify-center overflow-hidden ${
                ...
                >
                  {preview ? (
                    ...
                    <div className="text-center p-4">
                      <FileImage
                        className={`w-8 h-8 sm:w-12 sm:h-12 mx-auto mb-2 ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}
                      />
                      <p
                        className={`text-xs sm:text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}
                      >
              ...
              <div className="space-y-3">
                ...
                <div
                  className={`rounded-xl sm:rounded-2xl border-2 border-dashed ${!result ? 'aspect-square sm:aspect-[4/3]' : 'min-h-[250px] sm:min-h-[350px]'} flex items-center justify-center overflow-hidden ${
                    isDarkMode ? 'border-gray-600 bg-gray-700' : 'border-gray-300 bg-gray-50'
                  }`}
                >
                  {result ? (
                    ...
                    <div className="text-center justify-center flex flex-col items-center p-4 w-full">
                      <p
                        className={`text-xs sm:text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-500'} mb-2 sm:mb-3`}
                      >
                        Processing...
                      </p>
                      <div
                        className={`w-full max-w-xs mx-auto bg-gray-200 rounded-full h-1.5 sm:h-2 ${isDarkMode ? 'bg-gray-700' : 'bg-gray-200'}`}
                      >
                        <div
                    ...
                    <div className="text-center justify-center flex flex-col items-center p-4">
                      <Sparkles
                        className={`w-8 h-8 sm:w-12 sm:h-12 mx-auto mb-2 ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}
                      />
                      <p
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mt-6 sm:mt-8">
          <div
            className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg border ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}
          >
